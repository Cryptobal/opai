...
/**
 * Tareas del usuario con fecha dentro de la ventana, como items de agenda.
...
export async function listAgendaTasks(
  ...
  const tasks = await prisma.crmTask.findMany({
    ...
    select: {
      id: true, title: true, dueAt: true, allDay: true,
      dealId: true, accountId: true, emailThreadId: true, assignedTo: true,
    },
    take: 200,
  });

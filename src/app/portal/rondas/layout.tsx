  ...
  return (
    <div
      ...
      style={{
        ...
        // En Rondas el scroll lo posee el componente (RondasPortalClient fija su
        // shell a 100svh y cada pantalla aporta su propio overflow-y-auto). Para
        // no crear un segundo contexto de scroll que compita en Android, este
        // layout NO scrollea (overflowY:visible); solo aporta altura estable
        // (100svh) y las safe-areas.
        height: '100svh',
        minHeight: '100svh',
        overflowY: 'visible',

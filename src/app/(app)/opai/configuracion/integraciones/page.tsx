...
import { Plug, Slack, ChevronRight, Server, HardDrive, CalendarDays, Mail } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="space-y-4">
        <Link href="/opai/configuracion/integraciones/gmail" className="block">
            ...
            <CardHeader className="flex-row items-center justify-between space-y-0">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <CardDescription>
                    Conectá tu cuenta para enviar y registrar correos del CRM
                  </CardDescription>
                </div>
              </div>
              <div className="flex items-center gap-2 shrink-0">
                <Badge variant={gmailConnected ? "success" : "secondary"}>
                  {gmailConnected ? "Conectado" : "Sin conectar"}
                </Badge>

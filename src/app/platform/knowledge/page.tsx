    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-status-info px-4 py-2 text-sm font-medium text-white hover:bg-teal-700 transition-colors"
        >
            ...
            <form onSubmit={handleUpload} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="mt-1 w-full text-sm text-gray-500 file:mr-4 file:rounded-lg file:border-0 file:bg-teal-50 file:px-4 file:py-2 file:text-sm file:font-medium file:text-teal-700 hover:file:bg-teal-100 dark:text-gray-400 dark:file:bg-teal-900/30 dark:file:text-status-info-fg"
                />
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg bg-status-info px-4 py-2 text-sm font-medium text-white hover:bg-teal-700 disabled:opacity-50 transition-colors"
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="rounded p-1 text-gray-400 hover:bg-red-50 hover:text-status-danger-fg dark:hover:bg-red-900/20 disabled:opacity-50"
                        title="Eliminar"
                      >
                        {deleting === item.id ? (
                          <Loader2 className="h-4 w-4 animate-spin" />

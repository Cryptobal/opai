/**
 * API Route: /api/ops/tickets/[id]/email-attachments
 * POST — Sube archivos a R2 (staging) para incluirlos en una respuesta
 *        de email saliente. NO persiste filas en la DB; el composer
 *        manda los `r2Key` resultantes a /reply, que los adjunta al
 *        OpsTicketComment del email enviado.
 *
 * Para adjuntos persistidos a nivel de ticket (subir / listar /
 * eliminar) ver /api/ops/tickets/[id]/attachments.
 */

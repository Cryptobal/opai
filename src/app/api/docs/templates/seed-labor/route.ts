...
const TEMPLATES = [
  {
    ...
    isDefault: true,
    tokensUsed: ["empresa.razonSocial", "empresa.direccion", "empresa.comuna", "empresa.rut", "empresa.repLegalNombre", "empresa.repLegalRut", "empresa.maxHorasSemanales", "system.todayLong", "guardia.fullName", "guardia.rut", "guardia.address", "guardia.commune", "guardia.city", "guardia.cargo", "guardia.currentInstallation", "guardia.contractStartDate", "guardia.contractEndDate", "guardia.bankName", "guardia.bankAccountNumber", "guardia.bankAccountType", "guardia.afp", "guardia.healthSystem"],
    content: doc([
      ...
      paragraph([text("Jornada de "), token("empresa.maxHorasSemanales"), text(" horas semanales en turnos rotativos.")]),

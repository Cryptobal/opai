...
export const NAV_MODULES: NavNode[] = [
    ...
    children: [
      ...
      // Supervisión (sub-módulo con N3)
      {
        ...
        children: [
          ...
          { key: "sup-reportes", href: "/ops/supervision/reportes", label: "Reportes", icon: FileBarChart, module: "ops", submodule: "supervision" },
  ...
  // ═════════════════════════════════════════════════════════
  {
    ...
    children: [
      ...
      { key: "config-integraciones-mcp", href: "/opai/configuracion/integraciones/mcp", label: "Servidor MCP", icon: Plug, module: "config", submodule: "integraciones", category: "comunicacion", hideInSidebar: true, adminOnly: true, description: "API keys para clientes MCP (Claude, Cursor, Grok Bot)" },

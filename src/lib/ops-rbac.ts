...
const ROLE_OPS_CAPABILITIES: Record<string, OpsCapability[]> = {
  ...
  jefe_operaciones: ROLE_POLICIES.jefe_operaciones.opsCapabilities,
  finanzas: ROLE_POLICIES.finanzas.opsCapabilities,
  ...
  solo_finanzas: ROLE_POLICIES.solo_finanzas.opsCapabilities,

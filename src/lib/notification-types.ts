...
export const NOTIFICATION_TYPES: NotificationTypeDef[] = [
  ...
  },
  {
    ...
    description: "Cuando un ticket excede su tiempo de SLA (solo campana en tiempo real; el email se consolida en el resumen diario)",
    module: "ops",
    submodule: "tickets",
    category: "Operaciones - Tickets",
    defaultBell: true,
  ...
  },
  {
    ...
    description: "Cuando un ticket está por exceder su SLA (solo campana en tiempo real)",
    module: "ops",
    submodule: "tickets",
    category: "Operaciones - Tickets",
    defaultBell: true,

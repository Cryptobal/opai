...
export const TOKEN_MODULES: TokenModule[] = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { key: "quote.insurancePolicyUF", label: "Monto Póliza RC (UF)", path: "insurancePolicyUF" },
      { key: "quote.polizaGarantiaMonto", label: "Monto Garantía (CLP)", path: "polizaGarantiaMonto", type: "currency" },
      { key: "quote.polizaRcDeducibleUF", label: "Deducible RC (UF)", path: "polizaRcDeducibleUF" },

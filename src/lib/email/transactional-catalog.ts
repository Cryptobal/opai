...
export const TRANSACTIONAL_EMAIL_CATALOG: TransactionalEmailKind[] = [
  ...
  { key: "dte_proforma_reminder",         label: "Recordatorio de proforma",          description: "Recordatorio al cliente para confirmar la proforma (hasta 3, en días hábiles).", module: "finance", category: "DTE - Facturación" },
  { key: "dte_payment_statement_reminder", label: "Recordatorio de estado de pago",   description: "Recordatorio al cliente para confirmar el estado de pago (hasta 3, en días hábiles).", module: "finance", category: "DTE - Facturación" },
  { key: "dte_client_action_notice",      label: "Aviso de confirmación del cliente", description: "Aviso interno a finanzas cuando el cliente aprueba, observa o agrega OC desde la landing de cobro.", module: "finance", category: "DTE - Facturación" },
  ...
  { key: "cobertura_alert",         label: "Cobertura diurna / nocturna",       description: "Snapshot de cobertura enviado desde el monitoreo de rondas al email de operaciones.", module: "operations", category: "Rondas" },
  { key: "rondas_monitor",          label: "Reporte de cierre de turno",        description: "Email con PDF al cerrar un turno de monitoreo de rondas. Destinatario: email de operaciones + extras del modal.", module: "operations", category: "Rondas" },
  ...
  { key: "control_nocturno_report", label: "Reporte de control nocturno",       description: "Resumen de control nocturno al email de operaciones (con PDF).", module: "operations", category: "Rondas" },

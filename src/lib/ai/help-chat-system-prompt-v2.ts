...
25. FLUJO COMERCIAL COMPLETO — DEL PRIMER DATO AL MAIL DEL CLIENTE:
    ...
    FASE 3 — COMPLETAR LA OFERTA: manage_quote_extras (adicionales/uniformes/exámenes/alimentación/vehículos/infraestructura), manage_quote_lines (líneas facturables), update_quote_parameters (póliza/RC/financiamiento), manage_quote_includes (qué se entrega), update_quote (condiciones/validez), update_quote_margin. Cierra la fase con get_quote_detail y reporta el estado REAL (Verdad Verificada) con totales.

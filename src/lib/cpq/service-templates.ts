...
export const SERVICE_TEMPLATES: ServiceTemplate[] = [
  ...
  },
  {
    ...
    shortLabel: "12/7+FDS",
    description: "1 puesto nocturno 4x4 Lun-Dom (2 guardias) + 1 puesto diurno 2x5 fin de semana (1 guardia)",
    icon: "CalendarClock",
    totalGuards: 3,
    positions: [
      {
      ...
      {
        name: "Control de Acceso Diurno Fin de Semana",
        shiftStart: "08:00",
        shiftEnd: "20:00",
        shiftPattern: "2x5",
        rolShiftPattern: "2x5",
        ...
        guardsCount: 1,
        baseSalary: 400000,
        description: "Turno diurno 08:00-20:00, fin de semana (Sáb-Dom)",
      },
    ],
  },
];

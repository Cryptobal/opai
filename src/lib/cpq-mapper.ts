...
function buildSectionsDefaults(cfg: TenantCompanyConfig) { return {
  ...
  s25_comparacion: {
    comparison_table: [
      { criterion: "Supervisión en terreno", market: "Ocasional", provider: "Permanente", highlight: true },
      { criterion: "Reportes en tiempo real", market: false, provider: true },
      { criterion: "Control de rondas verificable", market: false, provider: true, highlight: true },
      { criterion: "Respuesta a incidentes", market: "> 1 hora", provider: "< 15 min" },
      { criterion: "Reemplazo por ausencias", market: "> 4 horas", provider: "< 2 horas" },
      { criterion: "Documentación laboral", market: "Bajo demanda", provider: "< 24 horas" },
      { criterion: "Dashboard ejecutivo", market: false, provider: true },
      { criterion: "Reuniones de gestión", market: false, provider: "Mensuales" },
      { criterion: "Capacitación continua", market: false, provider: true },
      { criterion: "Canal de denuncias", market: false, provider: "Ley Karin" },
      { criterion: "Tiempo de implementación", market: "> 4 semanas", provider: "≤ 15 días" },
      { criterion: "Plan de contingencia", market: false, provider: true, highlight: true },
    ],
  },
  s26_porque_eligen: {

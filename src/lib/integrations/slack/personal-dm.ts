 ...
 *
 * Capa distinta del ruteo tenant→canal compartido. Si la notificación caerá en
 * un canal compartido (ruteo, default, sala, etc.), notify() omite el DM para
 * no duplicar. Reusa el

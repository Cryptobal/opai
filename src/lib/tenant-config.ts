...
const DEFAULTS: TenantCompanyConfig = {
  ...
  brandNameUpper: "GARD",
  website: "www.gard.cl",
  logoUrl: "/logo-gard.svg",

  brandingLogoFull: "/logo-gard.svg",
  brandingLogoIcon: "/logos/logo-escudo-azul.svg",
  brandingLogoWhite: "/logo-gard-blanco.svg",
  brandingLogoDark: "/logo-gard.svg",
  brandingFavicon: "/logos/logo-escudo-azul.svg",

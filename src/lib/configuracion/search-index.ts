...
export const CONFIG_SEARCH_INDEX: ConfigSearchItem[] = [
  ...
  },
  {
    type: "section",
    id: "roles-auditoria",
    label: "Auditoría de acceso financiero",
    group: "General",
    description: "Matriz efectiva de quién ve cifras de la empresa",
    keywords: "auditoria financiera banca caja facturacion deals quotes payroll rol acceso",
  },
  {
    type: "section",
    id: "grupos",
  ...
  },
  {
    ...
    group: "Inteligencia Artificial",
    description: "API keys y modelos por proveedor (OpenAI, Anthropic, Google)",
    keywords: "ia inteligencia artificial proveedores api key openai anthropic google modelo",
  },
  {
    type: "section",
    id: "auditoria",
  ...
  {
    type: "setting",
    sectionId: "fiscalizacion-dt",
    label: "Correo de aviso de fiscalización DT",
    group: "General",
    description: "Destinatario del aviso Art. 24 b y del reporte diario Art. 27 e",
    keywords: "fiscalizacion dt direccion trabajo reporte diario aviso inspector clave",
  },
  {
    type: "section",
    id: "firmas",
...
const SECTION_HREFS: Record<string, string> = {
  ...
  "roles-auditoria": "/opai/configuracion/roles/auditoria",
  ...
  "fiscalizacion-dt": "/opai/configuracion/fiscalizacion-dt",
...
const SECTION_LABELS: Record<string, string> = {
  ...
  "roles-auditoria": "Auditoría de acceso financiero",
  grupos: "Grupos",
  ...
  auditoria: "Auditoría",
  "fiscalizacion-dt": "Fiscalización DT",
  firmas: "Firmas",

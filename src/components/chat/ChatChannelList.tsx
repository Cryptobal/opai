            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="flex items-center gap-2.5 px-3 py-2.5">
                ...
                <div className="flex-1 space-y-1.5">
                  <div className="h-3.5 rounded bg-[rgba(255,255,255,0.06)] animate-pulse" style={{ width: `${50 + i * 8}%` }} />
                  <div className="h-2.5 rounded bg-[rgba(255,255,255,0.04)] animate-pulse" style={{ width: `${65 + i * 5}%` }} />
                </div>
              </div>
            ))}
          </div>

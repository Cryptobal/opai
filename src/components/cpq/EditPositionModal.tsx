            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <div className="flex gap-1.5">
                  <Button type="button" size="sm" variant={form.startTime === "08:00" && form.endTime === "20:00" ? "default" : "outline"} className="h-6 px-2 text-xs" onClick={() => setForm((p) => ({ ...p, startTime: "08:00", endTime: "20:00" }))}>Dia</Button>

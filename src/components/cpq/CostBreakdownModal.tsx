          ...
          {data && (
            <div className="space-y-3">
              <div className="rounded-md border p-3 sm:p-2">
                <p className="text-sm font-semibold uppercase text-muted-foreground">Haberes</p>
              ...
              <div className="rounded-md border p-3 sm:p-2">
                <p className="text-sm font-semibold uppercase text-muted-foreground">Aportes empresa</p>
                <div className="mt-1 space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span>SIS</span>
              ...
              <div className="rounded-md border p-3 sm:p-2">
                <p className="text-sm font-semibold uppercase text-muted-foreground">Provisiones</p>
                <div className="mt-1 space-y-1.5">
                  <div className="flex items-center justify-between">
              ...
              {worker && (
                <div className="rounded-md border p-3 sm:p-2">
                  <p className="text-sm font-semibold uppercase text-muted-foreground">Descuentos trabajador</p>
                  <div className="mt-1 space-y-1.5">
                    <div className="flex items-center justify-between">
                      <span>AFP</span>

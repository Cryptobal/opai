...
import {
  PREREGISTRATION_STATUS_CONFIG, DEFAULT_RECORD_TYPE_IDS,
  getRecordTypeLabel,
} from "@/lib/access-control/types";
import { formatRut, validateRut } from "@/lib/access-control/utils";
import type {
  PreregistrationStatus, AccessRecordType, CustomRecordType,
} from "@/lib/access-control/types";
...
export function ClientPreregistration({ installationId, createdBy }: Props) {
  ...
  // Available record type ids for this installation (defaults + active
  // custom types). Fetched from /api/access-control/config so the
  // dropdown reflects whatever the admin configured.

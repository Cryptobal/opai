      ...
      <div className="flex items-start gap-4">
        {info.faceIdPhotoUrl ? (
          ...
          <img
            ...
            alt={info.nombre}
            className="h-16 w-16 rounded-full object-cover border border-teal-500/30"
          />
        ) : (
          <div className="h-16 w-16 rounded-full bg-teal-600/30 border border-teal-500/30 flex items-center justify-center flex-shrink-0">
...
function Os10Badge({
  ...
  if (estado === "vigente") {
    return (
      <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 bg-emerald-400/10 border border-emerald-400/20 rounded-full px-2 py-0.5">

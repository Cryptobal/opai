    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-foreground">{session.nombre}</h2>
        </div>

        {/* Installation + Status — single row */}
        <div className="flex items-center gap-3 rounded-xl bg-card opai-glass-soft-m px-4 py-2.5">
          <MapPin className="h-4 w-4 shrink-0 text-muted-foreground" />
          <p className="flex-1 truncate text-sm text-foreground">{session.installationName}</p>
        ...
        <div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="rounded-xl bg-card opai-glass-soft-m px-3 py-2 text-center">
                <p className="text-xl font-bold text-foreground">{stats.completadas}</p>
                <p className="text-[10px] text-muted-foreground">
                  Completadas{" "}
                  <span className="text-muted-foreground">de {stats.total}</span>
                </p>
              </div>
              ...
              <div className="rounded-xl bg-card opai-glass-soft-m px-3 py-2 text-center">
                ...
                <p className="text-[10px] text-muted-foreground">Con retraso</p>
              </div>

              <div className="rounded-xl bg-card opai-glass-soft-m px-3 py-2 text-center">
                <p className="text-xl font-bold text-status-danger-fg">{stats.noRealizadas}</p>
                <p className="text-[10px] text-muted-foreground">No realizadas</p>
              </div>

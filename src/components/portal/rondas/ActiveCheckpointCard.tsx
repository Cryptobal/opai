      ...
      <div className={`mx-2 ${cardClass}`}>
        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            {/* Number badge — 36x36 rounded square with gradient */}
            <div
          ...
          <button
            ...
            className={`mt-2.5 flex w-full items-center justify-center gap-2 rounded-xl py-3 text-sm font-bold transition-all ${
              isMarking
                ? "text-teal-200"
                : canMark

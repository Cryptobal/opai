  ...
  return (
    <div className="grid grid-cols-1 gap-2">
      <button
        ...
        className="w-full min-h-[44px] rounded-lg bg-status-ok text-white hover:brightness-110 disabled:opacity-50 flex items-center justify-center gap-2 font-medium text-sm"
      >

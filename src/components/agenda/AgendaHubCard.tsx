  ...
  return (
    <Surface elevation={1} padding="md" className={cn("min-w-0 space-y-3", className)}>
      ...
      >
        ...
        <p className="min-w-0 flex-1 truncate text-[13px] font-semibold text-ds-text-1">
          Agenda
        </p>
      ...
      <div className="hidden min-h-11 min-w-0 items-center justify-between gap-2 lg:flex">
                  ...
                  {todayItems.map((i) => {
                    ...
                    if (i.source === "tarea") {
                      return (
                        <li key={`tarea-${i.id}`} className="min-w-0">
                          <Link
                            href={href}
                            className="flex min-h-11 items-center justify-between gap-2 rounded-ds-md border border-primary/30 bg-primary/10 px-2 py-1.5 text-[13px] text-ds-text-1 ds-tap"
                          >
                    ...
                    if (i.source === "google") {
                      return (
                        <li key={`google-${i.id}`} className="min-w-0">
                          <Link
                            href={href}
                            className="flex min-h-11 items-center justify-between gap-2 rounded-ds-md bg-ds-surface-3 px-2 py-1.5 text-[13px] text-ds-text-2 ds-tap"
                          >
                    ...
                    return (
                      <li key={`${i.type}-${i.id}`} className="min-w-0">
                        <Link
                          href={href}
                          className={`flex min-h-11 min-w-0 items-center justify-between gap-2 rounded-ds-md px-2 py-1.5 text-[13px] ds-tap ${
                            i.allDay ? "bg-tint-violet/60" : "bg-ds-surface-2"
                          }`}
                        >
                          <span
                            className={`min-w-0 truncate font-medium ${i.allDay ? "text-tint-violet-fg" : "text-ds-text-1"}`}
                          >

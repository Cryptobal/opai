...
export function CrmLeadDetailClient({ lead: initialLead }: { lead: CrmLead }) {
  ...
  const generalContent = (
      <div className="space-y-4 rounded-lg border border-border bg-card p-4 sm:p-5">
        ...
        {!isEditable && lead.notes && <TruncatedText label="Notas" text={lead.notes} maxChars={200} />}
      </div>
  );
        ...
        header={{
          ...
          extra: lead.phone ? (
            <div className="flex items-center gap-1.5">
              <a href={`tel:+56${lead.phone}`} title="Llamar"
              ...
              <a href={`https://wa.me/56${lead.phone}`} target="_blank" rel="noopener noreferrer" title="WhatsApp"

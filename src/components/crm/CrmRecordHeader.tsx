...
export function CrmRecordHeader({
  ...
  return (
    <div
      className={cn(
        "sticky top-0 lg:top-[var(--app-topbar-offset)] z-10 mb-4 sm:mb-5 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80",

...
/**
 * Bottom-sheet móvil para Acciones IA (long-press / chip del lector).
 * Reutiliza los mismos CorreoMenuItem que el menú contextual desktop.
 */
export function CorreoAiMenuSheet({
  open,
  items,
  onClose,
}: {

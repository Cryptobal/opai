...
/**
 * Caché por `threadId`: la cadena de contexto (desktop) y el banner de Copiloto
 * (móvil) piden las mismas cuentas sugeridas. Con este caché — resultado +
 * petición en vuelo — ambos consumidores comparten UNA sola petición a

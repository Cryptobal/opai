              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border text-left">
                    <th className="px-3 py-2 font-medium text-muted-foreground w-1/3">Cuenta</th>
                    <th className="px-3 py-2 font-medium text-muted-foreground">Descripción</th>
                    <th className="px-3 py-2 font-medium text-muted-foreground text-right w-32">Debe</th>
                    <th className="px-3 py-2 font-medium text-muted-foreground text-right w-32">Haber</th>

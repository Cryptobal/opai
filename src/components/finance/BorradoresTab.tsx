...
export function BorradoresTab({ canManage }: { canManage: boolean }) {
  return (
    <div className="space-y-3">
      <div>
        <h2 className="text-base font-semibold tracking-tight text-ds-text-1 flex items-center gap-2">
          <Repeat className="h-5 w-5 text-tint-violet-fg" strokeWidth={1.75} />

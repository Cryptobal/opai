...
/**
 * Clic derecho en una celda (desktop) abre el panel único.
 * Si la celda no está en la selección, primero se selecciona (como Sheets).
 ...
 * (sin abrir el panel: eso es clic derecho, que además selecciona si hace falta).
 */

...
const navigationCommands: CommandItem[] = [
  ...
  {
    id: 'nav-finanzas-notas',
    label: 'Notas de Crédito/Débito',
    description: 'Notas asociadas a DTE',
    category: 'navigation',
    icon: FileText,
    href: '/finanzas/facturacion/notas',
    keywords: ['nota credito', 'nota crédito', 'nota debito', 'nota débito', 'nc', 'nd', 'anular factura'],
    canShow: (role) => hasAppAccess(role, 'finance'),
  },
  {

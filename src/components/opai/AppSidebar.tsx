            ...
            return (
              <div key={item.href} className="flex flex-col">
                ...
                {/* Children (animated accordion).
                    NOTE: Sidebar profundidad máxima = N1 + N2. El N3 vive en
                    `<ModuleSubNav>` arriba del contenido, no en el sidebar.
                    Por eso aquí ignoramos cualquier `child.children` que la
                    data pueda traer y siempre renderizamos N2 como link plano. */}
                {!collapsed && (
                  <div
                    className={cn(
            ...
            {flyout.item.children && flyout.item.children.length > 0 ? (
              <>
                ...
                <div className="py-1.5 px-1.5 space-y-0.5">
                  {/* Flyout también limita a N1+N2: ignoramos cualquier

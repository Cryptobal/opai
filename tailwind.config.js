    ...
    extend: {
      colors: {
        ...
        tint: {
          ...
          'indigo-fg':   'hsl(var(--tint-indigo-fg))',
          cyan:          'hsl(var(--tint-cyan))',
          'cyan-fg':     'hsl(var(--tint-cyan-fg))',
          lime:          'hsl(var(--tint-lime))',
          'lime-fg':     'hsl(var(--tint-lime-fg))',
          orange:        'hsl(var(--tint-orange))',
          'orange-fg':   'hsl(var(--tint-orange-fg))',
          fuchsia:       'hsl(var(--tint-fuchsia))',
          'fuchsia-fg':  'hsl(var(--tint-fuchsia-fg))',
          slate:         'hsl(var(--tint-slate))',
          'slate-fg':    'hsl(var(--tint-slate-fg))',
        },
      },
      borderRadius: {
        lg: "var(--radius)",

...
export async function seedPricingCatalog(prisma: PrismaClient) {
  ...
  const plans = [
    ...
    },
    {
      ...
      includedModules: [
        ...
        "ops_supervision", "alertas_cobertura",
        "chat", "gamificacion", "protocolos_ia", "reportes_dt",
        "crm", "cpq", "ops_rondas", "ops_inventario", "ops_camaras",
  ...
  const addons = [
    ...
    { slug: "camaras", name: "Cámaras IP", pricingModel: "flat", priceAmount: 8, priceUnit: "mes", moduleKey: "ops_camaras", tag: "Operacional", sortOrder: 16 },
